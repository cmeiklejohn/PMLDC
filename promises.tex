...
\begin{itemize}
    %% TODO: Possible citation for RPC.
	%% TODO: Possible *MOD or Plilts reference should be placed here.
...
%% TODO: Cite Lasp and LVars
%% TODO: Cite Oz, Distributed Oz, and Derflow.
%% TODO: Add Alice, E.

%% call-streams: combination of rpc and message passing: async of message passing with procedure focus of rpc
%% Order preservation, regardless of call execution time
%% RPC the preferred programming paradigm
%% Futures in MultiLisp
%% "Extended futures": strongly typed, no runtime checking to distinguish values, correct propagation of errors, integrated into the "call-stream" abstraction and understand node partitions and network failures.
